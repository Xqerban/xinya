...
def _llm_choose_intervention(
    ...
    try:
        ...
        resp = create_chat_completion_json(
            client,
            schema_model=TransplantDecisionPayload,
            schema_name="xiaoya_transplant_decision",
        ...
        data = parse_structured_json(content, TransplantDecisionPayload)
